  ...
  return (
    <div className="flex h-screen justify-center items-center">
      <div class="card w-96 bg-base-100 shadow-xl">
        <div class="card-body">
          <h2 class="text-center text-secondary uppercase font-bold text-xl">
            Login
          </h2>
            ...
            <div class="form-control w-full max-w-xs">
              ...
              <input
                ...
                {...register("password", {
                  ...
                  minLength: {
                    value: 7,
                    message: "password will be 7 character or long",
                  },
                  pattern: {
                    value: /(?=.*[!#$%&?^*@~() "])(?=.{8,})/,
                    message: "your password must be strong improve now",
                  },
                })}
              />
              <label class="label">
